...
import com.ecommerce.category.service.AdminService;
...
public class AdminController {
    ...
    @CircuitBreaker(name = "Category", fallbackMethod = "CategoryFallback")
    ...
    public ResponseEntity<?> CategoryFallback(Exception e) {

        LOGGER.info("AdminController | CategoryFallback is started");
